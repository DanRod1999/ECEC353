...
* Exercise 2 Prob 1
*
* Program uses two pipes in order to send a string from the parent to the child.
* The child then capitalizes all the characters in the string.
* The second pipe then returns the new string back the parent where it is printed.
* 
*/
